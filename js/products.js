...
function bindButton(){
    $(anyClass).click(function(){
        ...
        intialiseProjects("case study");
            ...
            $(".blue-bg", this).stop().animate({width: "0%"},800,"easeInQuint");   
    });
}
function transWorkSections(section){
    switch (section){
        ...
        $(".big-header").stop().css({display: "none"}).animate({top: "-100px"},800,"easeInQuint",function(){
            createWorkElements();
        });
        break;
    }
...
function createWorkElements(){
    $('#mCSB_1_container').append($('<div/>', {'class': 'inner-pb'}));
		...
		"images/products/station.png","images/products/truck.jpg","images/products/car.jpg"];
		var Title = ["VEHICON","REELAX",
		"SL-GAS","B2B ENERGY SOLUTIONS","ENYO COMMUNITY OFFERINGS","ENYO-PAY"];
		var Sub = ["VEHICLE MAINTENANCE AND CONCIERGE SERVICES","ONE-STOP LIFESTYLE HUB",
		"SUPERIOR LIQUIFIED GAS","BUSINESS TO BUSINESS ENERGY SOLUTIONS","ENYO COMMUNITY OFFERINGS","ENYO-PAY"];
...
function createCaseStudy(){
	...
	var csImages0 = ["images/products/repair.jpg","images/products/car.jpg","images/products/truck.jpg",
	"images/products/station.png","images/pngs/pump.jpg","images/pngs/pump2.jpg"];
	var csImages1 = ["images/products/car.jpg","images/products/pump.jpg","images/products/station.png",
	"images/products/pump2.jpg","images/pngs/truck.jpg","images/pngs/repair.jpg"];
	var csImages2 = ["images/products/truck.jpg","images/products/pump.jpg","images/products/pump2.jpg",
	"images/products/station.png","images/pngs/pump.jpg","images/pngs/pump2.jpg"];
	var csImages3 = ["images/products/station.png","images/products/repair.jpg","images/products/car.jpg",
	"images/products/pump.jpg","images/pngs/truck.jpg","images/pngs/pump2.jpg"];
	var csImages4 = ["images/pngs/truck.jpg","images/products/station.png","images/products/repair.jpg","images/products/car.jpg",
	"images/products/pump.jpg","images/pngs/pump2.jpg"];
	var csImages5 = ["images/products/car.jpg","images/products/station.png","images/products/repair.jpg",
	"images/products/pump.jpg","images/pngs/truck.jpg","images/pngs/pump2.jpg"];
	...
	var Sub = ["VEHICLE MAINTENANCE AND CONCIERGE SERVICES","ONE-STOP LIFESTYLE HUB",
	"SUPERIOR LIQUIFIED GAS","BUSINESS TO BUSINESS ENERGY SOLUTIONS","ENYO COMMUNITY OFFERINGS","ENYO-PAY"];
	var Des = ["VEHICON, available at participating ENYO retail stations and other locations accross Nigeria revolutionaries the services related to vehicle maintenance. In addition to free pick-up and drop off by qualified and trained mechanics; we also provide stop-gap cars depending on the needs of our customers.<br /><br />The VEHICON team is trained to ensure the best products are used for restoring the performance of all cars being maintained at our locations. VEHICON is the lead marketer of our brand of lubricant products accross Nigeria.",
	"At ENYO retail outlets feature 'REELAX', a lifestyle space hosting a variety of premium outlets, ranging from cofee shops, convienience stores to members lounge with free Wi-Fi amongst other offerings.",
	"Our Superior Liquified Gas will boost the switch of families from kerosene and firewood to clean LPG.<br /><br />SLGas is safe to use, and is available at all ENYO retail stations and participating retailers. We also offer free home delivery services to participating neighbourhoods.",
	"B2B-ES: ENYO retail offers forward-thinking solutions for business that seek to optimize their power needs across their corporate fleet, offices and/or site installations.<br /><br />Services here includes:Fuels planning & supply, lubricants & technical services, power sales and equipment maintenance",
	"At ENYO retail, a visit to any of our service outlets provides the opportunities to join a community where members get access to all REELAX lounges, free pick up and drop off when using VEHICON, free Wi-Fi while at service stations and other benefits.",
	"ENYO-Pay is a fully integrated propietary solution that allows customers to make payments for everyday domestic bills whilst paying for their fuel products either at the station or online."];
	var Architect = ['Click the email contact below for more info regarding this product and additional services.<br/><br/>' + '<a class="email-link" href="mailto:enyohr@enyoretail.com?subject=Product Enquiry">enyohr@enyoretail.com</a>',
	'Click the email contact below for more info regarding this product and additional services.<br/><br/>' + '<a class="email-link" href="mailto:enyohr@enyoretail.com?subject=Product Enquiry">enyohr@enyoretail.com</a>',
	'Click the email contact below for more info regarding this product and additional services.<br/><br/>' + '<a class="email-link" href="mailto:enyohr@enyoretail.com?subject=Product Enquiry">enyohr@enyoretail.com</a>',
	'Click the email contact below for more info regarding this product and additional services.<br/><br/>' + '<a class="email-link" href="mailto:enyohr@enyoretail.com?subject=Product Enquiry">enyohr@enyoretail.com</a>',
	'Click the email contact below for more info regarding this product and additional services.<br/><br/>' + '<a class="email-link" href="mailto:enyohr@enyoretail.com?subject=Product Enquiry">enyohr@enyoretail.com</a>',
	'Click the email contact below for more info regarding this product and additional services.<br/><br/>' + '<a class="email-link" href="mailto:enyohr@enyoretail.com?subject=Product Enquiry">enyohr@enyoretail.com</a>'];
	...
	"SUPERIOR LIQUIFIED GAS","B2B-ES","ENYO COMMUNITY OFFERINGS","ENYO-PAY"];
    ...
    $(".csd-pic").each(function(){
		var f;
	if (csNum == 0){ f = csImages0; }
	if (csNum == 1) { f = csImages1; }
	if (csNum == 2) { f = csImages2; }
	if (csNum == 3) { f = csImages3; }
	if (csNum == 4) { f = csImages4; }
	if (csNum == 5) { f = csImages5; }
...
function populateWorkBg(){
    for(var i=0;i<= 5;i++){
		...
		var bgImages = ["images/products/repair.jpg","images/products/car.jpg","images/products/truck.jpg",
		"images/products/station.png","images/products/truck.jpg","images/products/car.jpg"];
		var Title = ["VEHICON","REELAX",
		"SL-GAS","B2B ENERGY SOLUTIONS","ENYO COMMUNITY OFFERINGS","ENYO-PAY"];
		var Loc = ["VEHICLE MAINTENANCE AND CONCIERGE SERVICES","ONE-STOP LIFESTYLE HUB",
