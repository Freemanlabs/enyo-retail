...
var Images2 = [];
// NAV //
var navItems = ["Home","About Us","Our Work","Products","Contact Us"];
var navUrl = ["#Home","about/index2.html","work/index.html","products/index.html","contact/"];
...
$(".pl-line2").animate({marginLeft: "-60px",opacity:1},800,"easeInQuint",function(){
    $(".pl-sage-logo").delay(400).animate({height: "61px"},800,"easeOutQuint",function(){
        $(".pl-sage-slogan img").animate({opacity: 1},1000,"easeOutQuint",function(){
            $(".pl-copy").animate({opacity:1},800,"easeInQuint");
        });
    });
});    
